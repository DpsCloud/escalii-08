...
const StatusCards = () => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8">
      <div className="card bg-white rounded-xl shadow-sm p-4 sm:p-6">
        ...
        <div className="flex items-center">
          <div className="relative w-14 h-14 sm:w-16 sm:h-16 mr-3 sm:mr-4 flex-shrink-0">
            <svg className="progress-ring" width="56" height="56" viewBox="0 0 60 60">
            ...
            <div className="absolute inset-0 flex items-center justify-center text-base sm:text-lg font-bold">
              62%
            </div>
          </div>
          <div>
            <p className="text-gray-800 font-medium text-sm sm:text-base">Bom progresso!</p>
      ...
      <div className="card bg-white rounded-xl shadow-sm p-4 sm:p-6">
        ...
        <div className="flex items-center">
          ...
          <div>
            <p className="text-gray-800 font-medium text-sm sm:text-base">100% de presença</p>
      ...
      <div className="card bg-white rounded-xl shadow-sm p-4 sm:p-6">
        ...
        <div className="flex items-center">
          ...
          <div>
            <p className="text-gray-800 font-medium text-sm sm:text-base">9 Dimensões da Imaturidade</p>
      ...
      <div className="card bg-white rounded-xl shadow-sm p-4 sm:p-6">
        ...
        <div className="flex items-center">
          ...
          <div>
            <p className="text-gray-800 font-medium text-sm sm:text-base">Disponível ao final</p>
